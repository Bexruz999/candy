...
<header class="header {{ $page === 'home' ? 'header-main' : '' }}">
    <div class="container">
        <div class="header-content">
            ...
            <div class="header-wrap">
                <ul class="header-menu">
                    <li>
                        <a href="{{ route('home') }}" {{ $page === 'home' ? 'class=active' : '' }}>
                             {{ __('settings.Главная') }}
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('about') }}" {{ $page === 'about' ? 'class=active' : '' }}>
                            {{ __('settings.О компании') }}
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('products') }}" {{ $page === 'products' ? 'class=active' : '' }}>
                             {{ __('settings.Продукция') }}
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('partners') }}" {{ $page === 'partners' ? 'class=active' : '' }}>
                             {{ __('settings.Стать партнёром') }}
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('vacancy') }}" {{ $page === 'vacancy' ? 'class=active' : '' }}>
                            {{ __('settings.Вакансии') }}
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('contact') }}" {{ $page === 'contact' ? 'class=active' : '' }}>
